...
export const  Reservations= () => {
  ...
  const handleDistrictCheckboxChange = (district: string) => {
    ...
    return (
      <div className="flex flex-wrap items-center gap-4 p-4 bg-white border rounded-lg shadow-lg max-w-[1400px] mx-auto space-y-0 space-x-0 md:space-x-8 ">
        {/* Location Filter */}
        ...
        >
          ...
          <img
              src="https://img.icons8.com/ios/50/sort-down.png"
              alt="Dropdown Icon"
              className="w-4 h-4"
             />
        </button>
        ...
        <div className="relative z-10 w-full sm:w-full md:w-auto ml-0 md:ml-12">
          ...
          >
            <img
            src="https://img.icons8.com/ios/50/performance.png"
            alt="Location Icon"
            className="w-6 h-6" 
          />
       ...
       <div className="relative w-full sm:w-full md:w-72">
        ...
        <input
          ...
          className="px-12 py-2 text-center border rounded-lg w-full sm:w-full md:w-72 bg-white focus:outline-none focus:ring-2 focus:ring-[#584822]"
        />
      </div>
        {/* Search Button */}
