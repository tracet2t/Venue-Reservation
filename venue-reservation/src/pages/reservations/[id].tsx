    ...
    const fetchVenueInfo = async () => {
      try {
        ...
        if (response.ok) {
          ...
          // Handle time slots based on schedule
          if (data.schedule === 'Entire Day') {
            setTimeSlots([
              '6:00 AM - 7:00 AM',
              '7:00 AM - 8:00 AM',
              '8:00 AM - 9:00 AM',
              '9:00 AM - 10:00 AM',
              // Add other full-day time slots
            ]);
          } else if (data.schedule === 'Half Day') {
            setTimeSlots([
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Select onValueChange={field.onChange} value={field.value}>
                        ...
                        <SelectItem value="23-24">23:00 AM - 9:00 AM</SelectItem>
