...
const Footer = () => {
  return (
    ...
    <div className="max-w-8xl mx-auto p-8 grid grid-cols-1 md:grid-cols-4 gap-8">
      {/* First Column */}
      <div className="flex flex-col">
        <h3 className="text-[#6A5B3A] text-2xl mb-2">Venue Reservation</h3>
      ...
      {/* Second Column */}
      <div className="flex flex-col">
        <h3 className="text-[#6A5B3A] text-2xl mb-2">Quick Links</h3>
      ...
      {/* Third Column */}
      <div className="flex flex-col">
        <h3 className="text-[#6A5B3A] text-2xl mb-2">Support</h3>
        <ul className="text-sm text-gray-600">
          <li> WhatsApp</li>
          <li> Telegram</li>
        </ul>
      ...
      {/* Fourth Column */}
      <div className="flex flex-col">
        <h3 className="text-[#584822] text-2xl mb-2">Get Updates</h3>
